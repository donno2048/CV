...
def get_pdf() -> bytes:
    ...
    link(c, "I OPTIMIZED SOME OF PYTHON'S SOURCE CODE", "Helvetica-Bold", 10, (.1, .2, .2), "https://github.com/python/cpython/pull/27102", (margins[1], 3 * section[1] / 4 - 100))
    ...
    link(c, "I CONTRIBUTED TO RUST'S SOURCE CODE", "Helvetica-Bold", 10, (.1, .2, .2), "github.com/rust-lang/rust/pull/115253", (margins[1], 3 * section[1] / 4 - 60))
